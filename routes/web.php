...
// ── Public placeholder routes (prevent 404 on named routes used in views) ──
...
// ── Frontend content (slug-based URLs) ───────────────────────────────────────
...
Route::get('/portfolio/{slug}',       [FrontEndController::class, 'pfcategory'])->name('pfcategory.single');
Route::get('/page/{slug}',            [FrontEndController::class, 'page'])->name('page.single');
Route::get('/tag/{slug}',             [FrontEndController::class, 'tag'])->name('tag.single');
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
    ...
    Route::post('/menu/save-order',  [MenuController::class, 'saveOrder'])->name('menu.save.order');
