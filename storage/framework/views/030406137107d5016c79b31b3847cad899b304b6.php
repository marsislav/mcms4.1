        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="banner-content">
                    <h2 class="text-white"><?php echo e($page->name); ?></h2>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="left-side-wrapper">
                    <div class="single-blog blog-style-2 mb-60 wow fadeInUp" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeInUp;">
                        <div class="blog-content">
                            <div class="actual_content"><?php echo $page->content; ?></div>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH /home/marsisla/public_html/resources/views/page.blade.php ENDPATH**/ ?>