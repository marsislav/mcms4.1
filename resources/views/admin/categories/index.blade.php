...
@section('content')
    ...
    {{-- Live autocomplete search (като vali.bg) --}}
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('category.delete', ['id' => $category->id]) }}"
                                   ...
                                   onclick="return confirm('Изтриване на \'{{ $category->name }}\'?')">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    @else
...
(function () {
    ...
    var searchUrl  = '{{ route("category.search") }}';
    var editBase   = '{{ url("admin/category/edit") }}';
    var deleteBase = '{{ url("admin/category/delete") }}';
